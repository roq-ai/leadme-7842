...
export function RequestListPage(props: RequestListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRequests({
        ...
        order: params.order,
        searchTermKeys: ['name.contains', 'email.contains', 'phone.contains', 'additional_info.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'additional_info', header: 'Additional Info', accessorKey: 'additional_info' },
