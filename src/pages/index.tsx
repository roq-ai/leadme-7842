  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless lead generation with Leadme, your directory of over 1000 lead form generators. Connect your requests to numerous suppliers with just a few clicks."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsZWFkJTIwZ2VuZXJhdGlvbnxlbnwwfHx8fDE2OTE4MTE2NDh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless lead generation with Leadme, your directory of over 1000 lead form generators. Connect your requests to numerous suppliers with just a few clicks.`}
            </Text>
            <Box
